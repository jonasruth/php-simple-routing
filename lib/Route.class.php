...
class Route
{
    ...
    public function check()
    {
        ...
        foreach ($this->routeList as $rulename => $rules) {
            ...
            if (preg_match($rules['pattern'], $url, $matches)) {
                ...
                if (
                    (isset($rules['params']) && is_array($rules['params'])) &&
                    (isset($rules['params_order']) && is_array($rules['params_order']))
                ) {
    ...
    public function createLink($routeName, $params = array())
    {
        ...
        if (isset($this->routeList[$routeName]['params']) && is_array($this->routeList[$routeName]['params'])) {
